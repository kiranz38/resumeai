      ...
      <section className="relative overflow-hidden bg-gray-50">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 pb-8 pt-10 sm:pb-24 sm:pt-24 lg:pb-28 lg:pt-28">
          <div className="max-w-xl text-center lg:max-w-lg lg:text-left">
            {/* Urgency hook */}
            <p className="mb-3 inline-block rounded-full border border-primary/20 bg-primary/5 px-3 py-0.5 text-[11px] font-semibold text-primary backdrop-blur-sm sm:mb-4 sm:py-1 sm:text-sm">
            ...
            <div className="mt-5 flex flex-wrap items-center justify-center gap-2 sm:mt-10 sm:gap-3 lg:justify-start">
              <div className="flex -space-x-1.5 sm:-space-x-2">
                {AVATAR_FACES.map((a) => (
                  <div
                    key={a.initial}
                    className={`flex h-6 w-6 items-center justify-center rounded-full ${a.color} text-[9px] font-bold text-white ring-1 ring-white sm:h-8 sm:w-8 sm:text-xs sm:ring-2`}
                  >
                    {a.initial}
                  </div>
                ))}
          ...
          {/* Stats strip */}
          <p className="mt-4 text-center text-[10px] text-gray-400 sm:mt-12 sm:text-sm lg:mt-16 lg:text-left">
