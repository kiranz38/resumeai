  ...
  return (
    <div>
      ...
      {jobs.length < MAX_JOBS && (
        <button
          onClick={addJob}
          className="mt-4 flex items-center gap-1 text-sm font-medium text-primary hover:text-blue-700"
        >
      ...
      <div className="mt-6 flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 p-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-white hover:bg-primary-hover disabled:cursor-not-allowed disabled:opacity-50"
        >
          {isLoading ? (
            <>
