        ...
        {onBulkGenerate && selectedIds.size > 0 && (
          <div className="sticky top-4 z-30 flex flex-shrink-0 items-center gap-2">
            ...
            <button
              ...
              className="animate-pulse-ring inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white shadow-lg hover:bg-primary-hover"
            >
        ...
        <div className="fixed inset-x-0 bottom-0 z-40 border-t border-gray-200 bg-white/95 px-3 py-2.5 shadow-lg backdrop-blur-sm sm:px-4 sm:py-3">
          <div className="mx-auto flex max-w-4xl items-center justify-between gap-3">
            ...
            <div className="flex flex-shrink-0 items-center gap-2 sm:gap-3">
              ...
              <button
                onClick={handleBulkGenerate}
                className="inline-flex items-center gap-1.5 rounded-lg bg-primary px-3 py-2 text-xs font-semibold text-white shadow-sm hover:bg-primary-hover sm:gap-2 sm:px-5 sm:py-2.5 sm:text-sm"
              >
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
