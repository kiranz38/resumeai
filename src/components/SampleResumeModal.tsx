  ...
  return (
    <>
      <button
        ...
        className="cursor-pointer inline-flex items-center gap-1.5 text-sm font-medium text-primary hover:text-primary sm:gap-2 sm:rounded-full sm:border sm:border-white/40 sm:bg-white/40 sm:px-5 sm:py-2 sm:text-gray-600 sm:shadow-sm sm:shadow-black/5 sm:ring-1 sm:ring-black/5 sm:backdrop-blur-md sm:hover:bg-white/70 sm:hover:text-gray-900"
      >
